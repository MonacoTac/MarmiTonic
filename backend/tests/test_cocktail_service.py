...
class TestCocktailService:
    ...
    def test_load_local_data_success(self, cocktail_service, mock_sparql_service):
        ...
        with patch('rdflib.Graph') as mock_graph_class:
            ...
            mock_graph.parse.assert_called_once_with(mock_sparql_service.local_graph_path, format="turtle")
            assert cocktail_service.graph == mock_graph

    def test_load_local_data_failure(self, cocktail_service):
        with patch('rdflib.Graph') as mock_graph_class:
